...
$adminpass		='admin';	// configure admin password here
$whois			='ban/whois.php?ip=';
#$whois			='Enter Whois Information Here!';
...
<head>
<title>Website IP Ban Tool</title>
...
<h1 style="text-align: center; font-weight: bold; background-color: green;">Admin Control Panel</h1><br>
<h3 style="text-align: center;">IP Ban Manager v1.0.0</h3>
<body>
<div id='container'>
...
<?=$err?>
	<span class='title'>Ban IP Address</span>
		<form action='' method='POST'>	
	<table width='100%'>
		<tr>
		...
		<tr>
			<td colspan='2'>
				<div class='buttons'><button type="submit" class="positive" name="addfield"> <img src="ban/images/apply.png" alt=""/> Ban IP Address</button></div></td>
		</tr>
			</form>	
	</table>
</td>
...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en"> 
<head>
<title>IP Ban Manager v1.0.0 - Admin Control Panel</title>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<style type="text/css" media="screen">@import url(ban/style.css);</style>
</head>
<body>
...
<p style="text-align: center;"><a href="https://sourceforge.net/projects/ipbanmanager" target="_blank">IP Ban Manager v1.0.0</a></p>
</html>
<?}?>